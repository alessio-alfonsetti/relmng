...
<body>
   ...
   <div  class="form">
            <form id="contactform" method="POST" action="/inserisci-trasporto">
                ...
                <p class="contact"><label for="azienda_provenienza">Azienda Smaltitrice del materiale</label></p>
                <input id="azienda_provenienza" name="azienda_provenienza" placeholder="Azienda Smaltitrice" tabindex="4" type="text">
                
                <p class="contact"><label for="data_inizio">Data di inizio</label></p>
                <input id="data_inizio" name="data_inizio" placeholder="01/01/2017" tabindex="5" type="text">
                
                <p class="contact"><label for="ora_inizio">Ora di inizio</label></p>
                <input id="ora_inizio" name="ora_inizio" placeholder="16:00" tabindex="6" type="date">
                
                <p class="contact"><label for="data_fine">Data di fine</label></p>
                <input id="data_fine" name="data_fine" placeholder="01/01/2017" tabindex="7" type="text">
 
 				<p class="contact"><label for="ora_fine">Ora di fine</label></p>
                <input id="ora_fine" name="ora_fine" placeholder="17:00" tabindex="8" type="date">
